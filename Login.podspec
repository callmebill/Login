...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Xiao Gang"
  # s.authors            = { "Xiao Gang" => "huangzhigang1024@qq.com" }
  # s.social_media_url   = "http://twitter.com/Xiao Gang"
  ...
  s.resources = 'Resources/*.{png,xib,storyboard,xcassets}'
